...
//	 * SMS服务商-url
//	 */	
//	public static final String SMS_SERVICE_URL = "http://106.ihuyi.cn/webservice/sms.php?method=Submit";
//	/**
//	 * SMS服务商-账号
//	 */	
...
//	public static final String SMS_SERVICE_PASSWORD = "anbVtW";
	 ...
	 * 云信，发送通知类和运营类短信
	 */
	public static String SMS_MSG_URL = "https://api.netease.im/sms/sendtemplate.action";
	/**
	 * SMS服务商-账号
	 */	
	 ...
	 * TOKEN的生命周期(单位：毫秒)
	 */
	public static Long TOKEN_LEFTTIME = 15*24*3600000L;
	
	public static Long Admin_TOKEN_LEFTTIME = 1*24*3600000L;
	 ...
	 * 注册短信验证码模板ID
	 */
	public static Integer REGSMSTEMPID = 3058583;
	/**
	 * 注册短信验证码模板ID
	 */
	public static Integer NOTICESMSTEMPID = 3053488;
	/**
	/**
	 * 短信发送成功
	 */
